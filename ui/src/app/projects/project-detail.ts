...
import {ObjectLike, ResourceObject, SingleResourceDoc} from '@vloryan/ts-jsonapi-form/jsonapi/model';
...
import {EmptyFetchOpts, extractFetchOpts, FetchOpts} from '@vloryan/ts-jsonapi-form/jsonapi/';
...
export class ProjectDetail extends DocumentFormComponent{
  ...
  updateOptions(ev: Event) {
    ...
    this.jsonApiService.SearchForClient({name: input.value}).pipe(
