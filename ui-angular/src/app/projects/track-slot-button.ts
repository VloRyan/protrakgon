...
import {DocumentForm} from '../../../../../../ts/ts-jsonapi-form/form';
import {EmptyFetchOpts, findInclude} from '../../../../../../ts/ts-jsonapi-form/jsonapi';
    ...
    const form = new DocumentForm({
      document: {
        data: {
          ...
          links: {
            self: `/api/v1/project/${this.projectId()}/slot`,
          }
        },
        included: undefined,
        jsonapi: undefined,
    ...
    const form = new DocumentForm({
      document: {
        data: {
          ...
          links: {
            self: `/api/v1/project/${this.projectId()}/slot/` + slot.id,
          }
        },
        included: undefined,
        jsonapi: undefined,
